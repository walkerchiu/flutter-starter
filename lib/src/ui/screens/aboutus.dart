...
class AboutUsScreenState extends State<AboutUsScreen> with SingleTickerProviderStateMixin {
                  ...
                  Container(
                    ...
                    child:
                      Row(
                        ...
                        children: <Widget>[
                          Text(I18n.of(context).menuAboutus, style: TextStyle(color: Color(0xFF595957), fontSize: 24)),
                          Container(
                            width: 60, height: 22,
                            child: 
                              FlatButton(
