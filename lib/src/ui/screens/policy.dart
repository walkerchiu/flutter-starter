...
class PolicyScreen extends StatefulWidget {
  ...
  @override
  PolicyScreenState createState() {
    return PolicyScreenState();
  }
}

class PolicyScreenState extends State<PolicyScreen> with SingleTickerProviderStateMixin {
                  ...
                  Container(
                    ...
                    child:
                      Row(
                        ...
                        children: <Widget>[
                          Text(I18n.of(context).menuPolicy, style: TextStyle(color: Color(0xFF595957), fontSize: 24)),
                          Container(
                            width: 60, height: 22,
                            child: 
                              FlatButton(
