...
import 'package:flutterstarter/src/ui/widgets/event_list.dart';
...
class EventScreen extends StatefulWidget {
  ...
  EventScreen(this._photo, this._title, this._content, this._date);
...
class EventScreenState extends State<EventScreen> with SingleTickerProviderStateMixin {
    ...
    return Scaffold(
      ...
      body: Column(
        children: <Widget>[
          ...
          widget._title == "" ? EventList() : ItemDetail("event", widget._photo, widget._title, widget._content, widget._date)
        ]
      ),
      drawer: DrawerMenu(1),
