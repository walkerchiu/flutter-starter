              ...
              if (snapshot.hasData) {
                return Expanded(child:
                          Column(
                            ...
                            children: <Widget>[
                              Header(false, I18n.of(context).menuEvent),
                              Expanded(child:
                                Stack(
                                  children: <Widget>[
                ...
                return Expanded(child:
                          Column(
                            ...
                            children: <Widget>[
                              Header(false, I18n.of(context).menuEvent),
                              ItemCard("event", "", I18n.of(context).info, content, ""),
                            ]
                          )
                        );
              }
  ...
  ListView buildList(List<Article> articles) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ItemCard("event", articles[index].photo, articles[index].title, articles[index].content, articles[index].date);
        });
  }
}
