...
import 'package:flutterstarter/src/ui/widgets/item_card.dart';
              ...
              if (snapshot.hasData) {
                return Expanded(child:
                          Column(
                            ...
                            children: <Widget>[
                              Header(false, I18n.of(context).menuNews),
                              Expanded(child:
                                Stack(
                                  children: <Widget>[
                ...
                return Expanded(child:
                          Column(
                            ...
                            children: <Widget>[
                              Header(false, I18n.of(context).menuNews),
                              Expanded(child: ItemCard("news", "", I18n.of(context).info, content, "")),
                            ]
                          )
                        );
              }
  ...
  ListView buildList(List<Article> articles) {
    return ListView.builder(
        ...
        itemBuilder: (context, index) {
          return ItemCard("news", articles[index].photo, articles[index].title, articles[index].content, articles[index].date);
        });
  }
}
